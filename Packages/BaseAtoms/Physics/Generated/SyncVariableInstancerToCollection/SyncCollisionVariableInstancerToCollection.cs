...
namespace UnityAtoms.BaseAtoms
{
    ...
    public class SyncCollisionVariableInstancerToCollection : SyncVariableInstancerToCollection<UnityEngine.Collision, CollisionVariable, CollisionVariableInstancer> { }
}
