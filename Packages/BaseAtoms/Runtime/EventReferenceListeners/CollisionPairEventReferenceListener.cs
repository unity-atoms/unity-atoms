...
namespace UnityAtoms.BaseAtoms
{
    ...
    public sealed class CollisionPairEventReferenceListener : AtomEventReferenceListener<CollisionPair, CollisionPairEvent, CollisionPairEventReference, CollisionPairUnityEvent> { }
}