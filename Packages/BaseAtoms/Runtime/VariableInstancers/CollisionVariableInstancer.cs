...
namespace UnityAtoms.BaseAtoms
{
    ...
    public class CollisionVariableInstancer : AtomVariableInstancer<CollisionVariable, CollisionPair, Collision, CollisionEvent, CollisionPairEvent, CollisionCollisionFunction> { }
}