...
namespace UnityAtoms.BaseAtoms
{
    ...
    /// </summary>
    [Serializable]
    public sealed class CollisionReference : AtomReference<Collision, CollisionPair, CollisionConstant, CollisionVariable, CollisionEvent, CollisionPairEvent, CollisionCollisionFunction, CollisionVariableInstancer>, IEquatable<CollisionReference>
        {
